        ...
        Icons.getIcon('actions-localize', Icons.sizes.large).then((localizeIconMarkup) => {
          Icons.getIcon('actions-edit-copy', Icons.sizes.large).then((copyIconMarkup) => {
            Icons.getIcon('actions-localize-deepl', Icons.sizes.large).then((localizeDeeplIconMarkup) => {
              ...
              $(document).on('click', this.triggerButton, (e) => {
                e.preventDefault();
                ...
                if ($triggerButton.data('allowTranslate')) {
                  ...
                  actions.push('<div class="row">'
                    ...
                    + '<input type="radio" name="mode" id="mode_translate" value="localizedeepl" style="display: none">'
                    + '<br>' + TYPO3.lang['localize.wizard.button.deepltranslate'] + '</label>'
                    + '</div>'
                    + '<div class="col-sm-9">'
                ...
                Wizard.addSlide('localize-choose-language', TYPO3.lang['localize.view.chooseLanguage'], '', SeverityEnum.info, ($slide) => {
                  Icons.getIcon('spinner-circle', Icons.sizes.large).then((markup) => {
